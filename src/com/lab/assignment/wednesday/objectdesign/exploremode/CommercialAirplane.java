...
public class CommercialAirplane extends Airplane
{
	...
	{
		return "You would like to fly on a commercial plane with " + doors + " doors, " + windows + " windows, " + seats + " seats, " + wheels
				+ " wheels, " + wings + " wings, " + pilot + " pilots, and " + flightAttendants + " flight attendants. You want the wingspan to be "
				+ wingSpan + " feet across. During your flight you would like to eat " + snacksServed + ". While flying the friendly skies you wish to drink " + whatTypeofDrink + ".";
	}
